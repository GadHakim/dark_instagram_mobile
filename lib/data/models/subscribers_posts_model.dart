class SubscribersPostsModel {
  bool success;
  List<SubscribersPost> result;

  SubscribersPostsModel({this.success, this.result});

  SubscribersPostsModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['result'] != null) {
      result = new List<SubscribersPost>();
      json['result'].forEach((v) {
        result.add(new SubscribersPost.fromJson(v));
      });
    }
  }
...
class SubscribersPost {
  ...
  SubscribersPost.fromJson(Map<String, dynamic> json) {
    publicationId = json['publication_id'];
    accountId = json['account_id'];
    likeCount = json['like_count'];
    contentHeight = json['content_height'];
    contentWidth = json['content_width'];
